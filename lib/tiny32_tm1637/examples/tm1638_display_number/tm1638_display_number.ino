/***********************************************************************
 * Project      :     tm1638_display_number
 * Description  :     Test Display Number on tm1638
...
void loop()
{
    ...
    /*** long one digit number ***/
    long _long_var = random(-9999999,99999999);
    tm1638_var.number_tm1638(_long_var);
    vTaskDelay(1000);

     /*** integer one digit number ***/
    int _int_var = random(-32768, 32767);
    tm1638_var.number_tm1638(_int_var);
    vTaskDelay(1000);

    /*** integer two digit number ***/
    int _int_var1 = random(-999, 999);
    int _int_var2 = random(-999, 999);
    tm1638_var.number_tm1638(_int_var2,_int_var1);
    vTaskDelay(1000);

      /*** float one digit number ***/
    float _float_var = random(-9999999, 9999999)*0.01;
    tm1638_var.number_tm1638(_float_var);
    vTaskDelay(1000);


    /*** float two digit number ***/
    float _float_var1 = random(-999, 999) * 0.1;
    float _float_var2 = random(-999, 999) * 0.1;
    tm1638_var.number_tm1638(_float_var1,_float_var2);
    vTaskDelay(1000);
